...
<template>
  <ul
    ...
    :style="{
      ...
      letterSpacing: `${settings.senderDetails.letterSpacing}px`,
      ...
      borderTop: `${settings.senderDetails.borderStyle} ${settings.senderDetails.borderColor} ${settings.senderDetails.border[0]}px`,
      borderRight: `${settings.senderDetails.borderStyle} ${settings.senderDetails.borderColor} ${settings.senderDetails.border[1]}px`,
      borderBottom: `${settings.senderDetails.borderStyle} ${settings.senderDetails.borderColor} ${settings.senderDetails.border[2]}px`,
      borderLeft: `${settings.senderDetails.borderStyle} ${settings.senderDetails.borderColor} ${settings.senderDetails.border[3]}px`,
  ...
  <ul
    ...
    :style="{
      ...
      letterSpacing: `${settings.recipientDetails.letterSpacing}px`,
      ...
      borderTop: `${settings.recipientDetails.borderStyle} ${settings.recipientDetails.borderColor} ${settings.recipientDetails.border[0]}px`,
      borderRight: `${settings.recipientDetails.borderStyle} ${settings.recipientDetails.borderColor} ${settings.recipientDetails.border[1]}px`,
      borderBottom: `${settings.recipientDetails.borderStyle} ${settings.recipientDetails.borderColor} ${settings.recipientDetails.border[2]}px`,
      borderLeft: `${settings.recipientDetails.borderStyle} ${settings.recipientDetails.borderColor} ${settings.recipientDetails.border[3]}px`,
  ...
  >
    <h3
      ...
      :style="{
        ...
        letterSpacing: `${settings.subject.letterSpacing}px`,
        ...
        borderTop: `${settings.subject.borderStyle} ${settings.subject.borderColor} ${settings.subject.border[0]}px`,
        borderRight: `${settings.subject.borderStyle} ${settings.subject.borderColor} ${settings.subject.border[1]}px`,
        borderBottom: `${settings.subject.borderStyle} ${settings.subject.borderColor} ${settings.subject.border[2]}px`,
        borderLeft: `${settings.subject.borderStyle} ${settings.subject.borderColor} ${settings.subject.border[3]}px`,
    ...
    <h4
      ...
      :style="{
        ...
        letterSpacing: `${settings.reference.letterSpacing}px`,
        ...
        borderTop: `${settings.reference.borderStyle} ${settings.reference.borderColor} ${settings.reference.border[0]}px`,
        borderRight: `${settings.reference.borderStyle} ${settings.reference.borderColor} ${settings.reference.border[1]}px`,
        borderBottom: `${settings.reference.borderStyle} ${settings.reference.borderColor} ${settings.reference.border[2]}px`,
        borderLeft: `${settings.reference.borderStyle} ${settings.reference.borderColor} ${settings.reference.border[3]}px`,
