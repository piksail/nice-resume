...
<template>
  <h1
    ...
    :style="{
      ...
      borderTop: `${settings.name.borderStyle} ${settings.name.borderColor} ${settings.name.border[0]}px`,
      borderRight: `${settings.name.borderStyle} ${settings.name.borderColor} ${settings.name.border[1]}px`,
      borderBottom: `${settings.name.borderStyle} ${settings.name.borderColor} ${settings.name.border[2]}px`,
      borderLeft: `${settings.name.borderStyle} ${settings.name.borderColor} ${settings.name.border[3]}px`,
